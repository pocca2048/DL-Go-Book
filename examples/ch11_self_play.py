"""
generate experience by self-playing
"""
import os
import sys
...
if __name__ == '__main__':
    main()
    # after ch11_init_q.py
    # python ch11_self_play.py --board-size 9 --agent-in qmodel.hdf5 --experience-out q_exp.hdf5 --temperature 0.5
