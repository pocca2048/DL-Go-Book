...
import h5py
from dlgo import agent, rl, scoring
...
# python ch9_init.py --board_size 9 --output_file agent.hdf5
# python ch9.py --board-size 9 --learning-agent agent.hdf5 --experience-out ex.hdf5