...
def generate_game(board_size, rounds, max_moves, temperature):
    ...
    encoder = get_encoder_by_name('oneplane', board_size=board_size)
...
def main():
    ...
    parser.add_argument('--board-out', type=str, default='feature.npy')
    parser.add_argument('--move-out', type=str, default='labels.npy')
